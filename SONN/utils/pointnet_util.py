...
import numpy as np
import tf_util
from tf_util import batch_norm_for_conv2d
...
def RG(short1_conv,short2_conv,bn_decay,is_training):
    ...
    short1_conv = batch_norm_for_conv2d(short1_conv, is_training,bn_decay=bn_decay, scope='bn1_R1')
    short2_conv = batch_norm_for_conv2d(short2_conv, is_training,bn_decay=bn_decay, scope='bn1_R2')
    short1=tf.math.add(short1_conv, short1)
    short2=tf.math.add(short2_conv, short2)

    short1 = batch_norm_for_conv2d(short1, is_training,bn_decay=bn_decay, scope='bn2_R1')
    short2 = batch_norm_for_conv2d(short2, is_training,bn_decay=bn_decay, scope='bn2_R2')
...
def acnn_module_rings(xyz, points, normals, npoint, radius_list, nsample_list, mlp_list,s1,s2, flag,is_training, bn_decay, scope, bn=True, use_xyz=True):
    ...
    with tf.variable_scope(scope) as sc:
        ...
        if flag is not None:
            ...
            short1_conv,short2_conv=RG(short1_conv,short2_conv,bn_decay,is_training)
