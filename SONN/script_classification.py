...
def call():
    ...
    substring_new1="eval avg class acc"
    arr=[substring,substring1,substring_new1]
    i=0
    ...
    writer.writerow([substring1,substring,substring_new1])
    file2.close()
    for i in range(1,50):
...
def write_file(substring2):
    ...
    substring1="Try"
    substring="eval accuracy"
    substring_new="eval avg class acc"
    arr=[substring_new,substring,substring1]
    tokens=[]
    tokens1=[]
    y_new=[]
    y_new1=[]
    ...
    with open ('dump/log_evaluate.txt', 'rt') as myfile:    # Open lorem.txt for reading text.
		...
		#print("inside if :")
            ...
            #print([count,y])
                ...
                save1=y
    myfile.close()
    with open ('dump/log_evaluate.txt', 'rt') as myfile1:    # Open lorem.txt for reading text.
        print(" have opened file :")
        for myline in myfile1:                   # For each line in the file,
            ...
            #print([count,y])
                ...
                save2=y1
    writer1.writerow([count1,save1,save2])   
            #writer.writerow(y)
            #else:
		#print("shut up :")
            #file2.write(tokens[1])
