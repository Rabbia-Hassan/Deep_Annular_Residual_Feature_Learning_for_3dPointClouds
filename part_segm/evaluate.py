...
parser.add_argument('--log_file', default='chuss.txt', help='Log dir [default: log_eval]')
...
DATA_PATH = os.path.join(DATA_DIR, '/home/rabbia/code/H5/repo/Deep_Annular_Residual_Feature_Learning_for_3dPointClouds/data', 'shapenetcore_partanno_segmentation_benchmark_v0_normal')
...
def eval_one_epoch(sess, ops):
    ...
    log_string('eval mean mIoU1: %f' % (mean_shape_ious))
