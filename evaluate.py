...
SHAPE_NAMES = [line.rstrip() for line in \
    open(os.path.join(DATA_DIR, '/home/rabbia/code/H5/repo/Deep_Annular_Residual_Feature_Learning_for_3dPointClouds/data/modelnet40_ply_hdf5_2048/modelnet40/shape_names.txt'))]
